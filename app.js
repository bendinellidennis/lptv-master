...
function replaySvgDefs(){return `<defs>
 <linearGradient id="sky" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#8dc6e7"/><stop offset="1" stop-color="#eef6fa"/></linearGradient>
 <linearGradient id="road" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#555d66"/><stop offset="1" stop-color="#24292f"/></linearGradient>
 <linearGradient id="dash" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#20262d"/><stop offset="1" stop-color="#090c10"/></linearGradient>
 <linearGradient id="redZone" x1="0" y1="0" x2="1" y2="1"><stop stop-color="#f43f5e" stop-opacity=".55"/><stop offset="1" stop-color="#ef4444" stop-opacity=".08"/></linearGradient>
 <linearGradient id="greenZone" x1="0" y1="0" x2="1" y2="1"><stop stop-color="#22c55e" stop-opacity=".45"/><stop offset="1" stop-color="#16a34a" stop-opacity=".05"/></linearGradient>
 <filter id="shadow" x="-30%" y="-30%" width="160%" height="180%"><feDropShadow dx="0" dy="8" stdDeviation="7" flood-color="#000" flood-opacity=".28"/></filter>
 <filter id="soft" x="-40%" y="-40%" width="180%" height="180%"><feGaussianBlur stdDeviation="12"/></filter>
 <marker id="arrowRed" markerWidth="10" markerHeight="10" refX="8" refY="5" orient="auto"><path d="M0,0 L10,5 L0,10 z" fill="#ef4444"/></marker>
 <marker id="arrowGreen" markerWidth="10" markerHeight="10" refX="8" refY="5" orient="auto"><path d="M0,0 L10,5 L0,10 z" fill="#16a34a"/></marker>
 </defs>`}
function replayCarRear(x,y,scale=1,color='#2f6fa6'){
 return `<g transform="translate(${x} ${y}) scale(${scale})" filter="url(#shadow)"><rect x="-56" y="-26" width="112" height="64" rx="20" fill="${color}"/><path d="M-40-22 L-25-48 H25 L40-22Z" fill="${color}"/><path d="M-25-42 H25 L34-22 H-34Z" fill="#b9d8e8"/><rect x="-43" y="17" width="25" height="12" rx="4" fill="#ef4444"/><rect x="18" y="17" width="25" height="12" rx="4" fill="#ef4444"/><rect x="-18" y="22" width="36" height="9" rx="3" fill="#d7dde2"/><rect x="-61" y="0" width="10" height="28" rx="5" fill="#171a1f"/><rect x="51" y="0" width="10" height="28" rx="5" fill="#171a1f"/></g>`}
function replayCarFront(x,y,scale=1,color='#cfd5dc'){
 return `<g transform="translate(${x} ${y}) scale(${scale})" filter="url(#shadow)"><rect x="-54" y="-27" width="108" height="66" rx="20" fill="${color}"/><path d="M-39-22 L-24-48 H24 L39-22Z" fill="${color}"/><path d="M-25-42 H25 L34-22 H-34Z" fill="#354a5b"/><circle cx="-34" cy="17" r="9" fill="#fff4b8"/><circle cx="34" cy="17" r="9" fill="#fff4b8"/><rect x="-19" y="22" width="38" height="9" rx="3" fill="#8d969f"/><rect x="-59" y="0" width="10" height="29" rx="5" fill="#171a1f"/><rect x="49" y="0" width="10" height="29" rx="5" fill="#171a1f"/></g>`}
function replayTruckRear(x,y,scale=1){return `<g transform="translate(${x} ${y}) scale(${scale})" filter="url(#shadow)"><rect x="-70" y="-75" width="140" height="120" rx="10" fill="#e6eaee"/><rect x="-58" y="-62" width="116" height="72" rx="5" fill="#c7ced5"/><path d="M-60-45 H60 M-60-20 H60" stroke="#a7afb8" stroke-width="5"/><rect x="-55" y="20" width="25" height="12" rx="3" fill="#ef4444"/><rect x="30" y="20" width="25" height="12" rx="3" fill="#ef4444"/><rect x="-19" y="22" width="38" height="10" rx="3" fill="#707982"/><rect x="-77" y="2" width="14" height="38" rx="6" fill="#171a1f"/><rect x="63" y="2" width="14" height="38" rx="6" fill="#171a1f"/></g>`}
function replayRoadBase(extra='',options={}){
 const tunnel=options.tunnel===true;
 return `<svg class="replay-simulation-svg" viewBox="0 0 960 540" role="img" aria-label="${esc(options.label||'Driving scenario')}">${replaySvgDefs()}
 <rect width="960" height="540" fill="${tunnel?'#1a2027':'url(#sky)'}"/>
 ${tunnel?'<path d="M80 390V155Q480-30 880 155V390" fill="#3c4650"/><path d="M135 390V178Q480 35 825 178V390" fill="#151a20"/>':'<path d="M0 215 Q170 130 335 206 T680 190 T960 205 V310 H0Z" fill="#7ca66c"/><path d="M0 244 Q190 185 365 235 T730 220 T960 235 V330 H0Z" fill="#568459"/><rect x="0" y="270" width="960" height="95" fill="#8ca86f"/>'}
 <polygon points="120,540 840,540 615,205 345,205" fill="#8f959a"/>
 <polygon points="165,540 795,540 595,205 365,205" fill="url(#road)"/>
 <path d="M480 535 L480 225" stroke="#f7f7f0" stroke-width="10" stroke-dasharray="38 30" opacity=".9"/>
 <path d="M190 535 L375 208 M770 535 L585 208" stroke="#f1f2f3" stroke-width="7" opacity=".75"/>
 ${extra}
 <path d="M0 470 Q180 430 330 468 Q480 505 630 468 Q790 430 960 470 V540 H0Z" fill="url(#dash)"/>
 <path d="M365 540 A115 115 0 0 1 595 540" fill="none" stroke="#090b0d" stroke-width="38"/><path d="M480 490V535 M430 500L389 535 M530 500L571 535" stroke="#2f3740" stroke-width="15" stroke-linecap="round"/>
 <rect x="390" y="484" width="180" height="38" rx="19" fill="#11161b" stroke="#3b4650"/><circle cx="432" cy="503" r="8" fill="#62d39a"/><rect x="454" y="497" width="82" height="12" rx="6" fill="#26313a"/>
 </svg>`}
function replaySceneSvg(question,step){
 const s=errorReplayScenario(question), mode=step<=0?'risk':step===1?'analysis':'correct', safe=mode==='correct';
 const red=`<g class="replay-path risk-path"><path d="M455 485 C430 420 350 360 330 270" fill="none" stroke="#ef4444" stroke-width="15" stroke-linecap="round" stroke-dasharray="18 14" marker-end="url(#arrowRed)"/></g>`;
 const green=`<g class="replay-path safe-path"><path d="M455 485 C468 425 474 365 478 305" fill="none" stroke="#16a34a" stroke-width="15" stroke-linecap="round" marker-end="url(#arrowGreen)"/></g>`;
 let extra='';
 if(s.type==='overtaking'){
  extra=`<path d="M310 260 Q480 145 650 260" fill="#66706f" opacity=".45"/><path d="M320 275 Q480 165 640 275" fill="#333a40"/>
  ${replayCarRear(480,316,.72,'#2d6e9f')}${replayCarFront(505,220,.34,'#d8dde2')}
  ${safe?green:red}${mode==='analysis'?'<ellipse cx="510" cy="225" rx="88" ry="55" fill="url(#redZone)"/><path d="M700 155 C630 175 575 195 535 217" stroke="#ef4444" stroke-width="7" fill="none" marker-end="url(#arrowRed)"/><g class="svg-callout"><rect x="675" y="105" width="225" height="58" rx="16" fill="#fff"/><text x="692" y="132">VEICOLO NASCOSTO</text><text x="692" y="151" class="sub">visuale interrotta dall’avvallamento</text></g>':''}`;
 }
 else if(s.type==='cyclist'){
  extra=`<g transform="translate(600 305) scale(.72)" filter="url(#shadow)"><circle cx="-25" cy="25" r="24" fill="none" stroke="#1d2329" stroke-width="7"/><circle cx="35" cy="25" r="24" fill="none" stroke="#1d2329" stroke-width="7"/><path d="M-25 25 L0-2 L35 25 L5 25Z M0-2L20-28 M0-2L-8-24" fill="none" stroke="#176b54" stroke-width="7" stroke-linecap="round"/><circle cx="21" cy="-42" r="11" fill="#d59c78"/><path d="M20-30L5-5 M20-25L35-5" stroke="#23465d" stroke-width="9" stroke-linecap="round"/></g>
  ${replayCarRear(safe?395:505,360,.76,'#315f8f')}
  <path d="M565 405 H${safe?'390':'505'}" stroke="${safe?'#16a34a':'#ef4444'}" stroke-width="6" stroke-dasharray="12 8"/><text x="440" y="430" fill="${safe?'#106b35':'#b91c1c'}" font-size="24" font-weight="800">${safe?'AMPIO SPAZIO':'TROPPO VICINO'}</text>
  ${mode==='analysis'?'<ellipse cx="580" cy="345" rx="125" ry="105" fill="url(#redZone)"/>':''}`;
 }
 else if(s.type==='blindspot'){
  return `<svg class="replay-simulation-svg top-view" viewBox="0 0 960 540" role="img" aria-label="${esc(replayUi(s.labelIt,s.labelEn))}">${replaySvgDefs()}<rect width="960" height="540" fill="#e8edf1"/><rect x="170" width="620" height="540" fill="#4b535b"/><path d="M480 0V540" stroke="#f5f5ef" stroke-width="10" stroke-dasharray="34 26"/>
  <g transform="translate(455 310) rotate(-2)" filter="url(#shadow)"><rect x="-70" y="-130" width="140" height="260" rx="46" fill="#315f8f"/><rect x="-48" y="-78" width="96" height="112" rx="18" fill="#bad3df"/><rect x="-52" y="55" width="104" height="42" rx="12" fill="#23435d"/><rect x="-82" y="-70" width="14" height="70" rx="7" fill="#15191d"/><rect x="68" y="-70" width="14" height="70" rx="7" fill="#15191d"/></g>
  <path d="M540 335 C725 330 810 405 850 520 L550 520Z" fill="${safe?'url(#greenZone)':'url(#redZone)'}"/>
  <g transform="translate(685 420) scale(.75)" filter="url(#shadow)"><circle cx="-24" cy="24" r="23" fill="none" stroke="#111820" stroke-width="7"/><circle cx="34" cy="24" r="23" fill="none" stroke="#111820" stroke-width="7"/><path d="M-24 24L0-5L34 24L4 24Z" fill="none" stroke="#e5a321" stroke-width="7"/><circle cx="15" cy="-41" r="11" fill="#c99370"/><path d="M15-29L0-5" stroke="#263b4c" stroke-width="9"/></g>
  <g transform="translate(230 60)"><rect width="210" height="125" rx="24" fill="#1c2630"/><path d="M20 105 Q105 25 190 105" fill="#92bed5"/><circle cx="160" cy="85" r="15" fill="${safe?'#22c55e':'#ef4444'}"/><text x="22" y="28" fill="#fff" font-size="20" font-weight="800">SPECCHIO LATERALE</text></g>
  ${safe?'<path d="M425 270 C350 220 340 175 375 135" fill="none" stroke="#16a34a" stroke-width="12" marker-end="url(#arrowGreen)"/><text x="275" y="120" fill="#106b35" font-size="24" font-weight="900">CONTROLLO SPALLA</text>':'<text x="610" y="505" fill="#9f1239" font-size="25" font-weight="900">AREA NON VISIBILE</text>'}
  ${mode==='analysis'?'<path d="M560 350 C650 315 760 335 825 410" fill="none" stroke="#ef4444" stroke-width="8" marker-end="url(#arrowRed)"/>':''}</svg>`;
 }
 else if(s.type==='crossing'){
  extra=`<g transform="translate(555 270)"><path d="M-120 65H120" stroke="#fff" stroke-width="18" stroke-dasharray="28 18"/></g><g transform="translate(585 265) scale(.72)" filter="url(#shadow)"><circle cx="0" cy="-58" r="15" fill="#c28a68"/><path d="M0-42V35 M0-15L-28 12 M0-12L28 8 M0 35L-24 75 M0 35L25 75" stroke="#263f54" stroke-width="12" stroke-linecap="round"/></g>
  ${safe?green:red}${mode==='analysis'?'<ellipse cx="575" cy="280" rx="115" ry="100" fill="url(#redZone)"/><path d="M760 150C700 175 650 220 610 260" fill="none" stroke="#ef4444" stroke-width="7" marker-end="url(#arrowRed)"/>':''}`;
 }
 else if(s.type==='largevehicle'){
  extra=`${replayTruckRear(480,300,.83)}${safe?'<path d="M335 430 Q480 360 625 430" fill="url(#greenZone)"/><path d="M400 395 L330 250 M560 395L630 250" stroke="#16a34a" stroke-width="7" stroke-dasharray="12 10"/><text x="366" y="447" fill="#0f6b35" font-size="25" font-weight="900">DISTANZA + VISUALE</text>':'<path d="M390 470 Q480 350 570 470Z" fill="url(#redZone)"/><text x="382" y="451" fill="#b91c1c" font-size="24" font-weight="900">ZONA CIECA</text>'}${mode==='analysis'?'<path d="M690 135 C625 180 580 238 545 292" stroke="#ef4444" stroke-width="7" fill="none" marker-end="url(#arrowRed)"/>':''}`;
 }
 else if(s.type==='phone'){
  extra=`${replayCarRear(500,300,.60,'#485d6c')}<g transform="translate(735 310) rotate(${safe?'24':'-8'})" filter="url(#shadow)"><rect x="-70" y="-125" width="140" height="250" rx="24" fill="#111820"/><rect x="-58" y="-105" width="116" height="202" rx="14" fill="${safe?'#28323b':'#dbeafe'}"/><circle cx="0" cy="110" r="8" fill="#64717c"/>${safe?'':'<rect x="-42" y="-70" width="84" height="12" rx="6" fill="#6ea8d8"/><rect x="-42" y="-42" width="66" height="10" rx="5" fill="#98bddd"/><rect x="-42" y="-15" width="76" height="10" rx="5" fill="#98bddd"/>'}</g>
  ${safe?'<path d="M730 385 C785 425 820 455 850 505" stroke="#16a34a" stroke-width="10" fill="none" marker-end="url(#arrowGreen)"/><text x="700" y="365" fill="#0f6b35" font-size="22" font-weight="900">TELEFONO FUORI USO</text>':'<path d="M625 230 L855 455" stroke="#ef4444" stroke-width="16"/><path d="M855 230 L625 455" stroke="#ef4444" stroke-width="16"/><ellipse cx="500" cy="300" rx="175" ry="110" fill="#111827" opacity=".32"/>'}`;
 }
 else if(s.type==='breakdown'){
  extra=`${replayCarRear(505,315,.78,'#7b8792')}<path d="M385 330 L420 265 L455 330Z" fill="#ffcc33" stroke="#b98200" stroke-width="8"/><path d="M335 355 L675 355" stroke="#f59e0b" stroke-width="5" stroke-dasharray="12 9"/>
  ${safe?'<path d="M525 405 C640 400 735 360 790 285" fill="none" stroke="#16a34a" stroke-width="12" marker-end="url(#arrowGreen)"/><rect x="742" y="210" width="125" height="70" rx="14" fill="#dbe7ef"/><text x="763" y="253" fill="#1f445a" font-size="21" font-weight="900">USCITA</text>':'<path d="M465 385 C460 440 455 480 455 505" fill="none" stroke="#ef4444" stroke-width="12" marker-end="url(#arrowRed)"/><text x="330" y="445" fill="#ffb0b0" font-size="23" font-weight="900">PERSONA IN CORSIA</text>'}${mode==='analysis'?'<ellipse cx="470" cy="430" rx="120" ry="82" fill="url(#redZone)"/>':''}`;
  return replayRoadBase(extra,{tunnel:true,label:replayUi(s.labelIt,s.labelEn)});
 }
 else if(s.type==='passenger'){
  return `<svg class="replay-simulation-svg passenger-view" viewBox="0 0 960 540" role="img" aria-label="${esc(replayUi(s.labelIt,s.labelEn))}">${replaySvgDefs()}<rect width="960" height="540" fill="#dbe5ec"/><rect x="70" y="80" width="820" height="380" rx="55" fill="#1b2730" filter="url(#shadow)"/><rect x="110" y="120" width="740" height="215" rx="30" fill="#a9d3e8"/><rect x="160" y="360" width="250" height="90" rx="35" fill="#334556"/><rect x="550" y="360" width="250" height="90" rx="35" fill="#334556"/><g transform="translate(650 285)"><circle cx="0" cy="-72" r="28" fill="#bf8b68"/><path d="M0-43V80 M0-10L-65 45 M0-5L58 42" stroke="#31526a" stroke-width="26" stroke-linecap="round"/><path d="M0 78L-55 145 M0 78L48 145" stroke="#1f3545" stroke-width="28" stroke-linecap="round"/></g><path d="M570 215 L735 440" stroke="${safe?'#16a34a':'#ef4444'}" stroke-width="18" stroke-linecap="round"/><circle cx="570" cy="215" r="18" fill="${safe?'#16a34a':'#ef4444'}"/><rect x="730" y="420" width="50" height="32" rx="8" fill="#111820"/>
  ${safe?'<text x="115" y="52" fill="#116235" font-size="26" font-weight="900">PASSEGGERO SEDUTO E ASSICURATO</text>':'<path d="M540 170 L805 450 M805 170 L540 450" stroke="#ef4444" stroke-width="18" opacity=".8"/><text x="115" y="52" fill="#991b1b" font-size="26" font-weight="900">NON PARTIRE PRIMA DEL CONTROLLO</text>'}</svg>`;
 }
 else if(s.type==='loading'){
  return `<svg class="replay-simulation-svg loading-view" viewBox="0 0 960 540" role="img" aria-label="${esc(replayUi(s.labelIt,s.labelEn))}">${replaySvgDefs()}<rect width="960" height="540" fill="#e8edf1"/><rect x="110" y="70" width="740" height="400" rx="35" fill="#cad2d9" filter="url(#shadow)"/><rect x="150" y="110" width="660" height="315" rx="20" fill="#505b65"/><g ${safe?'':'transform="rotate(-9 480 300)"'}><rect x="230" y="240" width="190" height="135" fill="#b87b48"/><rect x="450" y="190" width="240" height="185" fill="#c68a55"/><rect x="350" y="125" width="180" height="105" fill="#a76b3d"/></g>${safe?'<path d="M190 150 L760 395 M760 150 L190 395" stroke="#16a34a" stroke-width="15"/><circle cx="480" cy="275" r="45" fill="#16a34a"/><path d="M457 275L475 293L510 252" fill="none" stroke="#fff" stroke-width="13" stroke-linecap="round"/>':'<path d="M190 170 C380 110 610 120 770 215" stroke="#ef4444" stroke-width="12" stroke-dasharray="18 12" marker-end="url(#arrowRed)"/><text x="275" y="445" fill="#991b1b" font-size="28" font-weight="900">CARICO LIBERO DI MUOVERSI</text>'}</svg>`;
 }
 else if(s.type==='eco'){
  extra=`${replayCarRear(500,300,.58,'#4e6e83')}<g transform="translate(160 325)"><path d="M0 80A105 105 0 0 1 210 80" fill="#17222b" stroke="#4d5e6b" stroke-width="12"/><path d="M24 77A80 80 0 0 1 186 77" fill="none" stroke="${safe?'#16a34a':'#ef4444'}" stroke-width="18" stroke-dasharray="${safe?'0':'10 7'}"/><path d="M105 80L${safe?'143 33':'180 70'}" stroke="#fff" stroke-width="8" stroke-linecap="round"/><circle cx="105" cy="80" r="12" fill="#fff"/><text x="63" y="122" fill="#fff" font-size="21" font-weight="800">${safe?'FLUIDA':'BRUSCA'}</text></g>${safe?green:red}`;
 }
 else if(s.type==='routine'){
  return `<svg class="replay-simulation-svg routine-view" viewBox="0 0 960 540" role="img" aria-label="${esc(replayUi(s.labelIt,s.labelEn))}">${replaySvgDefs()}<rect width="960" height="540" fill="#eef2f5"/><g transform="translate(75 115)"><rect width="235" height="275" rx="28" fill="#fff" filter="url(#shadow)"/><rect x="25" y="35" width="185" height="105" rx="20" fill="#b9d8e8"/><path d="M55 125 Q117 55 180 125" fill="#354a5b"/><circle cx="118" cy="88" r="20" fill="#ef4444"/><text x="28" y="188" fill="#172533" font-size="34" font-weight="900">1  SPECCHIO</text><text x="28" y="226" fill="#566674" font-size="20">Controlla dietro e ai lati</text></g><g transform="translate(362 115)"><rect width="235" height="275" rx="28" fill="#fff" filter="url(#shadow)"/><path d="M55 92H180" stroke="#f59e0b" stroke-width="22" stroke-linecap="round"/><path d="M160 55L205 92L160 129" fill="none" stroke="#f59e0b" stroke-width="22" stroke-linecap="round"/><text x="28" y="188" fill="#172533" font-size="34" font-weight="900">2  SEGNALE</text><text x="28" y="226" fill="#566674" font-size="20">Comunica con anticipo</text></g><g transform="translate(649 115)"><rect width="235" height="275" rx="28" fill="#fff" filter="url(#shadow)"/>${replayCarRear(118,105,.65,'#315f8f')}<path d="M65 145C80 110 120 75 175 65" fill="none" stroke="${safe?'#16a34a':'#ef4444'}" stroke-width="10" marker-end="url(#${safe?'arrowGreen':'arrowRed'})"/><text x="28" y="188" fill="#172533" font-size="34" font-weight="900">3  MANOVRA</text><text x="28" y="226" fill="#566674" font-size="20">Muoviti solo se è sicuro</text></g>${safe?'':'<path d="M170 450L790 70" stroke="#ef4444" stroke-width="20" opacity=".75"/>'}</svg>`;
 }
 else {
  extra=`${replayCarRear(495,310,.65,'#315f8f')}${safe?green:red}<g transform="translate(685 120)"><rect width="190" height="100" rx="18" fill="#fff" filter="url(#shadow)"/><text x="24" y="40" fill="#172533" font-size="20" font-weight="900">${safe?'AZIONE CONTROLLATA':'AZIONE AFFRETTATA'}</text><text x="24" y="70" fill="#61717d" font-size="17">${safe?'osserva e mantieni margine':'margine insufficiente'}</text></g>`;
 }
 return replayRoadBase(extra,{label:replayUi(s.labelIt,s.labelEn)});
}
function errorReplayLegacyVisualHtml(question,step=0){
 const scenario=errorReplayScenario(question),phase=Math.min(2,step),state=phase===0?'risk':phase===1?'analysis':'correct';
 const stateTitle=state==='risk'?replayUi('AZIONE PERICOLOSA','DANGEROUS ACTION'):state==='analysis'?replayUi('ANALISI DEL PERICOLO','HAZARD ANALYSIS'):replayUi('COMPORTAMENTO CORRETTO','CORRECT BEHAVIOUR');
 return `<div class="replay-pro-scene ${state}">
  <div class="replay-pro-toolbar"><div><span>${esc(replayUi('SIMULAZIONE TECNICA','TECHNICAL SIMULATION'))}</span><strong>${esc(replayUi(scenario.labelIt,scenario.labelEn))}</strong></div><b>${stateTitle}</b></div>
  <div class="replay-svg-stage">${replaySceneSvg(question,phase)}</div>
  <div class="replay-focus-strip"><span>${esc(replayUi('PUNTO DA OSSERVARE','WHAT TO WATCH'))}</span><strong>${esc(replayUi(scenario.focusIt,scenario.focusEn))}</strong></div>
 </div>`;
}
...
function replayRealFilmScene(question,phase){
...
function errorReplayNextStep(questionId){errorReplayStep=Math.min(3,errorReplayStep+1);if(errorReplayStep>=3)errorReplayMarkCompleted(questionId);render()}
function errorReplayPlay(questionId){
 ...
 errorReplayTimer=setInterval(()=>{errorReplayStep++;if(errorReplayStep>=3){errorReplayStep=3;clearInterval(errorReplayTimer);errorReplayTimer=null;errorReplayMarkCompleted(questionId)}render()},delay);
}
...
render();setTimeout(()=>verifyReplayAssets().catch(()=>{}),250);if('serviceWorker'in navigator)navigator.serviceWorker.register('./sw.js').catch(()=>{});
})();
