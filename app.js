...
function bindViewSpecific(){
 ...
 if(route.name==='profile'){
   ...
   $('#clearProgress').onclick=()=>{if(confirm(t('resetConfirm'))){progress={seen:{},correct:{},wrong:{},exams:[],favourites:[],activity:{},knownWords:[],knownPhrases:[],review:{},bankVersion:TAG_BANK_VERSION};save(STORAGE,progress);localStorage.removeItem(SESSION);render()}}
 }
...
async function exportBackup(){
 const data={app:'Malta Driving Master',version:'8.2',exportedAt:new Date().toISOString(),progress,settings,userProfile};
