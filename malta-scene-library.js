...
(function(global){
 ...
 const entries=[
  /* Build 39.12.67 Replay245 REAL FREEZE VIDEO */
  {"key":"garagingParkingFineSevenEight245","category":"administrative-penalties","titleIt":"Garaging/parcheggio: violazioni 7–8 = €300","titleEn":"Garaging/parking: infringements 7–8 = €300","status":"ready","questionIds":["LPTV2026.016"],"expectedCorrect":[2],"engineSceneId":"MT_GARAGING_PARKING_FINE_7_8_245_V1","countryPackId":"MT-LPTV","visualStatus":"final-real-footage","required":["garaging","parking-infringement","administrative-penalty","seventh-eighth","300-euro","repeat-infringement","question-specific"],"prohibited":["reused-approved-video","generic-unrelated-scene","remote-freeze"]},
  {"key":"garagingParkingFineNineTen245","category":"administrative-penalties","titleIt":"Garaging/parcheggio: violazioni 9–10 = €400","titleEn":"Garaging/parking: infringements 9–10 = €400","status":"ready","questionIds":["LPTV2026.017"],"expectedCorrect":[2],"engineSceneId":"MT_GARAGING_PARKING_FINE_9_10_245_V1","countryPackId":"MT-LPTV","visualStatus":"final-real-footage","required":["garaging","parking-infringement","administrative-penalty","ninth-tenth","400-euro","repeat-infringement","question-specific"],"prohibited":["reused-approved-video","generic-unrelated-scene","remote-freeze"]},
  {"key":"garagingParkingFineElevenPlus245","category":"administrative-penalties","titleIt":"Garaging/parcheggio: 11 o più violazioni = €500","titleEn":"Garaging/parking: 11 or more infringements = €500","status":"ready","questionIds":["LPTV2026.018"],"expectedCorrect":[2],"engineSceneId":"MT_GARAGING_PARKING_FINE_11_PLUS_245_V1","countryPackId":"MT-LPTV","visualStatus":"final-real-footage","required":["garaging","parking-infringement","administrative-penalty","eleven-plus","500-euro","repeat-infringement","question-specific"],"prohibited":["reused-approved-video","generic-unrelated-scene","remote-freeze"]},
  {"key":"sovOperatorLicenceCategory245","category":"operator-licences","titleIt":"Veicoli per occasioni speciali: licenza operatore SOV","titleEn":"Special Occasion Vehicles: SOV Operator Licence","status":"ready","questionIds":["LPTV2026.019"],"expectedCorrect":[2],"engineSceneId":"MT_SOV_OPERATOR_LICENCE_CATEGORY_245_V1","countryPackId":"MT-LPTV","visualStatus":"final-real-footage","required":["special-occasion-vehicle","sov","operator-licence","chauffeur","luxury-vehicle","question-specific"],"prohibited":["reused-approved-video","generic-unrelated-scene","remote-freeze"]},
  {"key":"sovNoIntermediaryPlatform245","category":"special-occasion-vehicles","titleIt":"SOV: niente piattaforma intermediaria di prenotazione","titleEn":"SOV: no intermediary booking platform","status":"ready","questionIds":["LPTV2026.020"],"expectedCorrect":[2],"engineSceneId":"MT_SOV_NO_INTERMEDIARY_PLATFORM_245_V1","countryPackId":"MT-LPTV","visualStatus":"final-real-footage","required":["sov","special-occasion-vehicle","intermediary-booking-platform","booking-app","prohibited","question-specific"],"prohibited":["reused-approved-video","generic-unrelated-scene","remote-freeze"]},
...
,
  ...
  {"key":"licenceHoldingTwoYears230","category":"lptv-law","titleIt":"Tag LPTV: patente B UE valida da almeno due anni","titleEn":"LPTV Tag: valid EU Category B licence held for at least two years","status":"ready","questionIds":["LPTV2026.001"],"expectedCorrect":[2],"engineSceneId":"MT_LPTV_LICENCE_TWO_YEARS_230_V1","countryPackId":"MT-LPTV","visualStatus":"final-real-footage","required":["eu-category-b","driving-licence","two-years","lptv-tag","question-specific"],"prohibited":["reused-approved-video","generic-unrelated-scene","remote-freeze"]},
  {"key":"penaltyPointsSix230","category":"lptv-law","titleIt":"Tag LPTV: massimo sei punti di penalità","titleEn":"LPTV Tag: maximum six penalty points","status":"ready","questionIds":["LPTV2026.002"],"expectedCorrect":[1],"engineSceneId":"MT_LPTV_PENALTY_POINTS_SIX_230_V1","countryPackId":"MT-LPTV","visualStatus":"final-real-footage","required":["penalty-points","six-points","driver-record","lptv-tag","question-specific"],"prohibited":["reused-approved-video","generic-unrelated-scene","remote-freeze"]},
  {"key":"lptvPassengerCapacityEight230","category":"passenger-safety","titleIt":"Veicolo LPTV: fino a otto passeggeri oltre al conducente","titleEn":"LPTV vehicle: up to eight passengers besides the driver","status":"ready","questionIds":["LPTV2026.003"],"expectedCorrect":[2],"engineSceneId":"MT_LPTV_PASSENGER_CAPACITY_EIGHT_230_V1","countryPackId":"MT-LPTV","visualStatus":"final-real-footage","required":["lptv-vehicle","passengers","eight-passengers","driver","capacity","question-specific"],"prohibited":["reused-approved-video","generic-unrelated-scene","remote-freeze"]},
  {"key":"yPlateParkingClock230","category":"parking","titleIt":"Y-plate parcheggiata su strada: esponi l’orologio ufficiale","titleEn":"Y-plate parked on road: display the official parking clock","status":"ready","questionIds":["LPTV2026.004"],"expectedCorrect":[1],"engineSceneId":"MT_Y_PLATE_PARKING_CLOCK_230_V1","countryPackId":"MT-LPTV","visualStatus":"final-real-footage","required":["y-plate","on-street-parking","parking-clock","display","not-in-use","question-specific"],"prohibited":["reused-approved-video","generic-unrelated-scene","remote-freeze"]},
  {"key":"yPlateDayParkingTwoHours230","category":"parking","titleIt":"Y-plate su strada di giorno: massimo due ore","titleEn":"Y-plate on road by day: maximum two hours","status":"ready","questionIds":["LPTV2026.005"],"expectedCorrect":[2],"engineSceneId":"MT_Y_PLATE_DAY_PARKING_TWO_HOURS_230_V1","countryPackId":"MT-LPTV","visualStatus":"final-real-footage","required":["y-plate","on-street-parking","daytime","two-hours","05-01-16-59","question-specific"],"prohibited":["reused-approved-video","generic-unrelated-scene","remote-freeze"]},
  {"key":"yPlateNightParkingOneHour235","category":"parking","titleIt":"Y-plate su strada di notte: massimo un’ora","titleEn":"Y-plate on road at night: maximum one hour","status":"ready","questionIds":["LPTV2026.006"],"expectedCorrect":[1],"engineSceneId":"MT_Y_PLATE_NIGHT_PARKING_ONE_HOUR_235_V1","countryPackId":"MT-LPTV","visualStatus":"final-real-footage","required":["y-plate","on-street-parking","night-time","one-hour","17-00-05-00","question-specific"],"prohibited":["reused-approved-video","generic-unrelated-scene","remote-freeze"]},
  {"key":"parkingClockPenaltyFiveHundred235","category":"parking","titleIt":"Orologio parcheggio: sanzione amministrativa €500","titleEn":"Parking clock: €500 administrative penalty","status":"ready","questionIds":["LPTV2026.007"],"expectedCorrect":[3],"engineSceneId":"MT_PARKING_CLOCK_PENALTY_500_235_V1","countryPackId":"MT-LPTV","visualStatus":"final-real-footage","required":["parking-clock","transport-malta","administrative-penalty","500-euro","enforcement","question-specific"],"prohibited":["reused-approved-video","generic-unrelated-scene","remote-freeze"]},
  {"key":"garagingObligationContinues235","category":"garaging","titleIt":"Garaging approvato: l’obbligo resta","titleEn":"Approved garaging: the obligation remains","status":"ready","questionIds":["LPTV2026.008"],"expectedCorrect":[2],"engineSceneId":"MT_GARAGING_OBLIGATION_CONTINUES_235_V1","countryPackId":"MT-LPTV","visualStatus":"final-real-footage","required":["approved-garaging","operator-obligation","parking-garage","on-street-exception","lptv","question-specific"],"prohibited":["reused-approved-video","generic-unrelated-scene","remote-freeze"]},
  {"key":"lptvMaxWorkTwelveHours235","category":"driving-rest","titleIt":"LPTV: massimo 12 ore di lavoro in 24 ore","titleEn":"LPTV: maximum 12 working hours in 24 hours","status":"ready","questionIds":["LPTV2026.009"],"expectedCorrect":[2],"engineSceneId":"MT_LPTV_MAX_WORK_TWELVE_HOURS_235_V1","countryPackId":"MT-LPTV","visualStatus":"final-real-footage","required":["lptv-driver","working-time","twelve-hours","24-hour-period","taxi-driver","question-specific"],"prohibited":["reused-approved-video","generic-unrelated-scene","remote-freeze"]},
  {"key":"lptvWeeklyRestOneDay235","category":"driving-rest","titleIt":"LPTV: almeno un giorno di riposo ogni settimana","titleEn":"LPTV: at least one rest day every week","status":"ready","questionIds":["LPTV2026.010"],"expectedCorrect":[1],"engineSceneId":"MT_LPTV_WEEKLY_REST_ONE_DAY_235_V1","countryPackId":"MT-LPTV","visualStatus":"final-real-footage","required":["lptv-driver","weekly-rest","one-day","driver-rest","taxi-driver","question-specific"],"prohibited":["reused-approved-video","generic-unrelated-scene","remote-freeze"]},
  {"key":"platformFacialRecognition240","category":"booking-platform","titleIt":"Piattaforme: verifica identità con riconoscimento facciale","titleEn":"Platforms: driver identity verification by facial recognition","status":"ready","questionIds":["LPTV2026.011"],"expectedCorrect":[1],"engineSceneId":"MT_PLATFORM_FACIAL_RECOGNITION_240_V1","countryPackId":"MT-LPTV","visualStatus":"final-real-footage","required":["facial-recognition","identity-verification","booking-platform","authorised-driver","driver-account","question-specific"],"prohibited":["reused-approved-video","generic-unrelated-scene","remote-freeze"]},
  {"key":"driverAccountNoSharing240","category":"booking-platform","titleIt":"Account conducente LPTV: non può essere condiviso","titleEn":"LPTV driver account: it must not be shared","status":"ready","questionIds":["LPTV2026.012"],"expectedCorrect":[2],"engineSceneId":"MT_DRIVER_ACCOUNT_NO_SHARING_240_V1","countryPackId":"MT-LPTV","visualStatus":"final-real-footage","required":["driver-account","no-sharing","authorised-driver","smartphone","taxi-driver","question-specific"],"prohibited":["reused-approved-video","generic-unrelated-scene","remote-freeze"]},
  {"key":"operatorVehiclesNotExceedDrivers240","category":"operator-responsibilities","titleIt":"Licenza operatore: veicoli autorizzati non oltre i conducenti","titleEn":"Operator Licence: authorised vehicles cannot exceed registered drivers","status":"ready","questionIds":["LPTV2026.013"],"expectedCorrect":[1],"engineSceneId":"MT_OPERATOR_VEHICLES_NOT_EXCEED_DRIVERS_240_V1","countryPackId":"MT-LPTV","visualStatus":"final-real-footage","required":["operator-licence","authorised-vehicles","registered-drivers","fleet","vehicle-count","question-specific"],"prohibited":["reused-approved-video","generic-unrelated-scene","remote-freeze"]},
  {"key":"garagingParkingFineOneToFour240","category":"administrative-penalties","titleIt":"Garaging/parcheggio: violazioni 1–4 = €100","titleEn":"Garaging/parking: infringements 1–4 = €100","status":"ready","questionIds":["LPTV2026.014"],"expectedCorrect":[1],"engineSceneId":"MT_GARAGING_PARKING_FINE_1_4_240_V1","countryPackId":"MT-LPTV","visualStatus":"final-real-footage","required":["garaging","parking-infringement","administrative-penalty","first-to-fourth","100-euro","question-specific"],"prohibited":["reused-approved-video","generic-unrelated-scene","remote-freeze"]},
  {"key":"garagingParkingFineFiveSix240","category":"administrative-penalties","titleIt":"Garaging/parcheggio: violazioni 5–6 = €200","titleEn":"Garaging/parking: infringements 5–6 = €200","status":"ready","questionIds":["LPTV2026.015"],"expectedCorrect":[1],"engineSceneId":"MT_GARAGING_PARKING_FINE_5_6_240_V1","countryPackId":"MT-LPTV","visualStatus":"final-real-footage","required":["garaging","parking-infringement","administrative-penalty","fifth-sixth","200-euro","repeat-infringement","question-specific"],"prohibited":["reused-approved-video","generic-unrelated-scene","remote-freeze"]}
 ];
