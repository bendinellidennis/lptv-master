...
window.addEventListener('load',function(){
  try{
    if(!window.MDM_PILOT_ACCESS_BRIDGE){const s=document.createElement('script');s.src='mdm-pilot-access-4583146.js?v=45838252-server-authoritative';s.async=true;s.setAttribute('data-mdm-pilot-bridge','enforced');document.head.appendChild(s);}
    if(!window.MDM_PILOT_SCHOOL_DASHBOARD_BRIDGE){const school=document.createElement('script');school.src='mdm-pilot-school-dashboard-4583147.js?v=p002-ownership-20260908';school.async=true;school.setAttribute('data-mdm-pilot-school-bridge','enforced');document.head.appendChild(school);}
    ...
    if(!window.MDM_PWA_REFRESH_FIX){const refresh=document.createElement('script');refresh.src='mdm-pwa-refresh-458344.js?v=p002-ownership-20260908';refresh.async=true;refresh.setAttribute('data-mdm-pwa-refresh-fix','direct-school-queue');document.head.appendChild(refresh);}
