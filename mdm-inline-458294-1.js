...
window.addEventListener('load',function(){
  try{
    if(!window.MDM_PILOT_ACCESS_BRIDGE){const s=document.createElement('script');s.src='mdm-pilot-access-4583146.js?v=458315068-seat-enforcement';s.async=true;s.setAttribute('data-mdm-pilot-bridge','enforced');document.head.appendChild(s);}
    if(!window.MDM_PILOT_SCHOOL_DASHBOARD_BRIDGE){const school=document.createElement('script');school.src='mdm-pilot-school-dashboard-4583147.js?v=458315068-seat-control';school.async=true;school.setAttribute('data-mdm-pilot-school-bridge','enforced');document.head.appendChild(school);}
