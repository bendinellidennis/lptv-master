/* Malta Driving Master 45.8.34.2 — Real Exam Outcome Calibration */
(function(){
'use strict';
if(window.MDM_PROOFLOOP_EXAM_OUTCOME)return;

const VERSION='45.8.34.2';
...
function briefText(st){
 ...
 return [
  ...
  t('Stabilità nel tempo','Stability over time','Stabbiltà maż-żmien')+': '+(snap.proofLoop?.retentionPresent?t('Presente','Present','Preżenti'):t('Da consolidare','Needs consolidation','Trid tiġi kkonsolidata')),
  '',
...
function render(){
 ...
 card.innerHTML='<div class="mdm-exam-outcome-title"><div><small>MDM PROOFLOOP · 45.8.34.2</small><h2>🏁 '+esc(t('Real Exam Outcome','Real Exam Outcome','Riżultat Reali tat-Test'))+'</h2></div><span>↔</span></div>'+html();
 bind();
}
function bind(){
