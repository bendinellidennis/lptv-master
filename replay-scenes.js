...
global.ReplayEngine.registerScene({
 ...
 ui:{staticUntilFinal:true,useVideoFreezeFrames:false,phaseImages:['https://images.pexels.com/videos/3981828/pexels-photo-3981828.jpeg?auto=compress&dpr=1&h=750&w=1260','https://images.pexels.com/videos/4352130/pexels-photo-4352130.jpeg?auto=compress&dpr=1&h=750&w=1260','https://images.pexels.com/videos/8944424/pexels-photo-8944424.jpeg?auto=compress&dpr=1&h=750&w=1260'],hotspot:{left:50,top:54,radiusX:34,radiusY:31,instructionIt:'TOCCA LA PERSONA ASSISTITA',instructionEn:'TAP THE CASUALTY',ariaIt:'Tocca la persona su cui vengono controllate le funzioni vitali',ariaEn:'Tap the casualty whose vital functions are being checked'},phases:[{},{titleIt:'A — AIRWAY',titleEn:'A — AIRWAY',bodyIt:'Verifica subito che le vie aeree siano libere.',bodyEn:'Immediately check that the airway is clear.'},{titleIt:'B + C',titleEn:'B + C',bodyIt:'Controlla la respirazione e la circolazione: sono funzioni vitali urgenti.',bodyEn:'Check breathing and circulation: these are urgent vital functions.'},{titleIt:'ABC PRIMA DI TUTTO',titleEn:'ABC FIRST',bodyIt:'Le tre risposte corrette sono vie aeree, circolazione e respirazione.',bodyEn:'The three correct answers are airway, circulation and breathing.'}],phaseOptions:[{startRatio:.10,freeze:true},{startRatio:.38,freeze:true},{startRatio:.66,freeze:true},{startRatio:.05,autoplay:true,endRatio:.92}]},
