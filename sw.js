...
const ASSETS=[
 ...
 './styles.css?v=39.9.1',
 './app.js?v=39.9.1',
 './database.js?v=39.9.1',
 './content.js?v=39.9.1',
 './replay-engine.js?v=39.9.1',
 './replay-scenes.js?v=39.9.1',
 './scene-audit.js?v=39.9.1',
 './manifest.webmanifest',
 './icon-192.png',
 './icon-512.png',
 './replay-overtaking-fallback.webp','./replay-overtaking-photo.webp',
 './country-packs.js?v=39.9.1',
 './malta-pack.js?v=39.9.1',
 './replay-coach.js?v=39.9.1',
 './scene-catalog.js?v=39.9.1',
 './malta-scene-library.js?v=39.9.1',
 './scene-assets.js?v=39.9.1',
 './malta-scene-assets.js?v=39.9.1',
