const CACHE='mdm-build-39-1-cars2-4-zebra-stop';
const ASSETS=[
 './',
 './index.html',
 './styles.css?v=39.1',
 ...
 './database.js?v=39.1',
 './content.js?v=39.1',
 './replay-engine.js?v=39.1',
 './replay-scenes.js?v=39.1',
 './manifest.webmanifest',
 './icon-192.png',
 './icon-512.png',
 './replay-overtaking-fallback.webp','./replay-overtaking-photo.webp',
 './country-packs.js?v=39.1',
 './malta-pack.js?v=39.1',
 './replay-coach.js?v=39.1',
 './scene-catalog.js?v=39.1',
 './malta-scene-library.js?v=39.1',
 './scene-assets.js?v=39.1',
 './malta-scene-assets.js?v=39.1',
